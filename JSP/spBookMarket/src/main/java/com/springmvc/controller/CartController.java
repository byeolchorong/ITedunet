...
public class CartController {
    ...
    CartController(UnitsInStockValidator unitsInStockValidator) {
	...
	public void removeCartByNewItem(@PathVariable String bookId, HttpServletRequest request) {
		System.out.println("삭제 컨트롤러 도착: " + bookId);
		String sessionId = request.getSession(true).getId(); 
